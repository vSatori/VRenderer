...
void MeshFactory::createCube(Mesh& mesh, float length, float width, float height)
{
...
void MeshFactory::createSphere(Mesh& mesh, float radius, int level, int slice)
{
...
void MeshFactory::flipMesh(Mesh& mesh)
{
